...
def test_player():
    from agent.player import CChessPlayer
...
def test_self_play():
    from config import Config
    from worker.self_play import start
...
def test_cli_play():
    from play_games.test_cli_game import main
    main()

def test_gui_play():
    from play_games.test_window_game import main
    main()

def test_optimise():
    from worker.optimize import start
    from config import Config
    from lib.logger import setup_logger
    c = Config('mini')
    c.resource.create_directories()
...
def test_light():
    ...
    from environment.chessboard import Chessboard
    lboard = L_Chessboard()
...
def test_static_env():
    ...
    from environment.static_env import INIT_STATE
    from environment.lookup_tables import flip_move
    env = CChessEnv()
    env.reset()
...
def test_upload():
    from lib.web_helper import upload_file
    from config import Config
    c = Config('mini')
...
def test_download():
    from lib.web_helper import download_file
    from config import Config
    c = Config('mini')
...
def test_request():
    from lib.web_helper import http_request
    from config import Config
    c = Config('mini')
...
def fixbug():
    from config import Config
    from lib.data_helper import get_game_data_filenames, read_game_data_from_file, write_game_data_to_file
    import cchess_alphazero.environment.static_env as senv
    c = Config('distribute')
...
def plot_model():
    ...
    from config import Config
    from lib.model_helper import save_as_best_model
